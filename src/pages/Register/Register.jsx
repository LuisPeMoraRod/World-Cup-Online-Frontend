  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === OK)
        toast.success("Usuario creado exitosamente", { theme: "light" });
      ...
      <section>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            Su nombre de usuario debe empezar por una letra.
            <br />
          ...
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            Su nombre debe ser solamente con letras.
            <br />
          </p>
          ...
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            Su apellido debe ser solamente con letras.
            <br />
          </p>
          ...
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            El dato ingresado debe ser de la forma email@email.com.
            <br />
          </p>
          ...
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            La contraseña debe ser dentro de 6 y 8 caracteres.
            <br />
            Debe contener un número.
            <br />
            Debe contener una como mínimo una letra.
            <br />
          </p>
          ...
          <p
            id="uidnote"
            className={
              birthDateFocus && birthDate && !validBirthDate
                ? "instructions"
                : "offscreen"
            }
          >
          ...
          <label htmlFor="country" className="registerLabel">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className={validCountry || !country ? "hide" : "invalid"}
            />
          </label>
          <Select
          ...
          <label className="registerLabel">
            Acepto los{" "}
            <a href="terms&conditions" className="registerA">
              términos y condiciones
            </a>{" "}
            de la X-FIFA para completar mi registro
          </label>

          <p
            id="uidnote"
            className={
              conditionsFocus && !validConditions && !conditions
                ? "instructions"
                : "offscreen"
            }
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            Para poder registrarse debe aceptar los términos y condiciones .
            <br />
          </p>
